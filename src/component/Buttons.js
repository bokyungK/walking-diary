...
function Buttons ({ buttonName, cancelLink, handleFormSubmit, setCheckLocation }) {

    return (
        <div className={styles.Buttons}>
            {
                cancelLink === '/detail-diary' ?
                <button onClick={() => cancelLink === '/detail-diary' ? setCheckLocation(false) : ''} className={styles.button}>
