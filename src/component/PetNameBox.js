...
function PetNameBox ({ handleAddPetName, handleRemovePetName, defaultBox, appendPetNameBox, userPetName1 }) {
    return (
        <div className={styles.formItem}>
            <label className={styles.itemLabel}>반려견 이름</label>
            <input className={styles.itemInput} type='text' defaultValue={userPetName1} />
            {
                defaultBox && <>
